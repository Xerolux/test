...
SWITCHES = [
    ...
    {"name": "Dosing CL", "key": "DOS_1_CL", "icon": "mdi:flask"},
    {"name": "Dosing PHM", "key": "DOS_4_PHM", "icon": "mdi:flask-outline"},
    {"name": "External 1", "key": "EXT_1", "icon": "mdi:power-socket"},
    {"name": "External 2", "key": "EXT_2", "icon": "mdi:power-socket"},
]